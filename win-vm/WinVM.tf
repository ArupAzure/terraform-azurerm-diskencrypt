...
resource "azurerm_virtual_machine_extension" "CustomScript" {
 ...
 SETTINGS
   protected_settings = <<PROTECTED_SETTINGS
     {
        "commandToExecute": "powershell -ExecutionPolicy Unrestricted -File preparedisks.ps1",
        "fileUris": ["https://vmtfbackend01.blob.core.windows.net/scripts/preparedisks.ps1"]
     }
 PROTECTED_SETTINGS
